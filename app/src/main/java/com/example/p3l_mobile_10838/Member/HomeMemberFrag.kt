...
class HomeMemberFrag : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnBookingGym.setOnClickListener{
            val move = Intent(activity, BookingGymActivity::class.java)
            startActivity(move)
        }

        binding.btnBookingKelas.setOnClickListener{
            val move = Intent(activity, BookingKelasActivity::class.java)
            startActivity(move)
        }

//        binding.btnLogoutMember.setOnClickListener {
//            logoutUser()
//        }
    }
