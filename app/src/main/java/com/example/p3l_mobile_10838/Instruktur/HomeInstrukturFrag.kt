...
import com.example.p3l_mobile_10838.PresensiMember.JadwalInstrukturActivity
...
class HomeInstrukturFrag : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnIzinInstruktur.setOnClickListener{
            val move = Intent(activity, IzinInstrukturActivity::class.java)
            startActivity(move)
        }

        binding.btnPresensiMember.setOnClickListener{
            val move = Intent(activity, JadwalInstrukturActivity::class.java)
            startActivity(move)
        }
